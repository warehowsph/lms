...
$(document).ready(function(){
	...
	$.ajax({
	    url: base_url+'lms/assessment/stored_json',
	    type: "POST",
...
$(document).on("focusout",".score_class",function(){
	...
	var the_this = $(this);
	the_this.parent().css("background-color","yellow");
	$.ajax({
	    ...
	    complete: function(response){
	    	...
	    	if(result.status==1){
				...
				the_this.parent().css("background-color","red");
	    		console.log("fail");
	    	}
	    }
	});
