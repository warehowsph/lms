   ...
   <div class="container">
      <div class="row">
         <div class="col-md-3 col-sm-3">
            ...
            <a class="navbar-brand logo" href="<?php echo base_url(); ?>"><img src="<?php echo $_SESSION['S3_BaseUrl'] . $front_setting->logo; ?>" alt=""></a>
         </div>
         <!--./col-md-4-->
         <div class="col-md-9 col-sm-12">
            <ul class="header-extras">
               <li><i class="fa fa-envelope-o i-plain"></i>
                  <div class="he-text"><?php echo $this->lang->line('email_us'); ?><span><a href="mailto:<?php echo $school_setting->email; ?>"><?php echo $school_setting->email; ?></a></span></div>
               </li>
               <li><i class="fa fa-phone i-plain"></i>
                  <div class="he-text"><?php echo $this->lang->line('call_us'); ?><span><?php echo $school_setting->phone; ?></span></div>
               </li>
