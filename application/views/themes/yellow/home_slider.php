               ...
               <div class="carousel-inner">
                  ...
                  ?>
                     <div class="item <?php if ($banner_first) echo 'active'; ?>">
                        ...
                        <img src="<?php echo $_SESSION['S3_BaseUrl'] . $banner_img_value->dir_path . $banner_img_value->img_name; ?>" alt="" />
                     </div>
                  <?php
                     $banner_first = FALSE;
                  }
                           ...
                           <ul id="ticker01" class="newsticker" style="height: 666px; top: 124.54px;">
                              ...
                              ?>
                                 <li><a href="<?php echo site_url('read/' . $banner_notice_value['slug']) ?>">
                                       <div class="date"><?php echo date('d', strtotime($banner_notice_value['date'])); ?><span><?php echo date('F', strtotime($banner_notice_value['date'])); ?></span></div><?php echo $banner_notice_value['title']; ?>
                                    </a></li>
                              <?php
                              }
                              ?>
