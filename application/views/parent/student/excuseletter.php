...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-flask"></i> <?php echo $this->lang->line('lms_excuse_letter'); ?>
        </h1> 
    </section>
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="col-md-12">
                ...
                <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('lms_excuse_letter'); ?></h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box-body table-responsive">
                        <div class="download_label"> <?php echo $this->lang->line('lms_excuse_letter'); ?> </div>
                            <div>
                                ...
                                <?php foreach($results as $value) { ?>
                                    <tr>
                                        ...
                                        <td><?php if($value['status'] == 0) { echo $this->lang->line('pending'); } else { echo  $this->lang->line('approve'); }?></td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a data-placement="left" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" href="<?php echo base_url(); ?>parent/parents/remove_leave/<?php echo $value['id'];?>" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete')?>" class="btn btn-default btn-xs"><i class="fa fa-trash" ></i> </a>
                                        </td>
                                    </tr>
                                <?php }?>
                                </tbody>
...
<div class="modal fade" id="homework_docs" tabindex="-1" role="dialog" aria-labelledby="evaluation" style="padding-left: 0 !important">
    <div class="modal-dialog " role="document">
        <div class="modal-content modal-media-content">
            ...
            <form role="form" id="addexcuseletter_form" method="post" enctype="multipart/form-data" action="">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select type="text" name="student" id="student" class="form-control ">
                                            ...
                                            foreach ($student_list as $key => $student) { ?>
                                                <option value="<?php echo $student['id']; //.','.$student['class'].','.$student['section'] ?>"><?php echo $student['firstname'] . " " . $student['lastname']?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apply_date" id="apply_date" class="form-control date" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('from')." ".$this->lang->line('date'); ?></label><small class="req"> *</small>
                                        <input type="text" name="from_date" id="from_date" class="form-control date" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('to')." ".$this->lang->line('date'); ?></label><small class="req"> *</small>
                                        <input type="text" name="to_date" id="to_date"  class="form-control date" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function get(id) {
        $.ajax({
            url: "<?php echo site_url("parent/parents/get_details") ?>/"+id,
            type: "POST",
    ...
    function add_leave() {
        $('#title').html('<?php echo $this->lang->line('add')." ".$this->lang->line('lms_excuse_letter'); ?>');
        $('#homework_docs').modal( {
            backdrop: 'static',
            keyboard: false,
            show: true
    ...
    $("#addexcuseletter_form").on('submit', (function (e) {
        e.preventDefault();
        var $this= $(this).find("button[type=submit]:focus");

        $.ajax({
            url: "<?php echo site_url("parent/parents/excuse_letter_add") ?>",
            type: "POST",
