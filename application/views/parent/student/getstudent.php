                  ...
                  <div class="tab-content">
                     ...
                     <div class="tab-pane" id="documents">
                        <div class="timeline-header no-border">
                           <!-- <button type="button"  data-student-session-id="<?php //echo $student['student_session_id'] 
                                                                                 ?>" class="btn btn-xs btn-primary pull-right myTransportFeeBtn"> <i class="fa fa-upload"></i>  <?php //echo $this->lang->line('upload_documents'); 
                                                                                                                                                                                 ?></button> -->
                           ...
                           <div id="timeline_list">
                              ...
                              <?php } else { ?>
                                 <ul class="timeline timeline-inverse">
                                    ...
                                    ?>
                                       <li class="time-label">
                                          <!-- <span class="bg-blue"><?php //echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['timeline_date']));
                                                                     ?></span> -->
                                       </li>
                                       <li>
                                                ...
                                                <div class="bgtgray">
                                                   ...
                                                   ?>
                                                      ...
                                                      <div class="col-sm-3 pull ">
                                                         <div class="description-block">
                                                            <h5 class="description-header"><?php echo $this->lang->line('quality') . " " . $this->lang->line('points') ?> : <span class="description-text"><?php echo $exam_quality_points . "/" . $exam_credit_hour . '=' . number_format($exam_quality_points / $exam_credit_hour, 2, '.', ''); ?>
                                                               </span></h5>
                                                         </div>
                                                      </div>
