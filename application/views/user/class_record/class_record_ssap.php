                  ...
                  <div class="box box-warning">
                     ...
                     <div class="box-body">
                        <div class="table-responsive">
                           ...
                           ?>
                           <table id="class_record" class="table table-striped table-bordered table-hover class_record nowrap">
                              <thead>
                                 <tr>
                  ...
                  <div class="box box-warning">
                     ...
                     <div class="box-body">
                        <div class="table-responsive">
                           ...
                           $totRow = 0;
                           ?>
                           <table id="attendance" class="table table-striped table-bordered table-hover attendance nowrap">
                              <thead>
                                 <tr>
