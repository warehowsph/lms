         ...
         <div class="modal-dialog modal-dialogfullwidth">
            ...
            <div class="modal-content modal-contentfull">
               <div class="modal-header">
                  ...
                  <div class="questionlogo"><img src="<?php echo $_SESSION['S3_BaseUrl']; ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo(); ?>" alt="<?php echo $this->customlib->getAppName() ?>" /></div>
               </div>
               <div class="exambgtop">
