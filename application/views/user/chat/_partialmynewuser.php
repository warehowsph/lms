            ...
            <li class="contact" data-chat-connection-id="<?php echo $user_value->id; ?>">
               <div class="wrap">
                  ...
                  if ($user_value->user_details->image == "") {
                     $img = $_SESSION['S3_BaseUrl'] . "uploads/staff_images/no_image.png";
                  } else {
                     $img = ($user_value->user_details->user_type == "staff") ? $_SESSION['S3_BaseUrl'] . "uploads/staff_images/" . $user_value->user_details->image : base_url() . $user_value->user_details->image;
                  }
                  ?>
