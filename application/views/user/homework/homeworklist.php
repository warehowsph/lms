         ...
         <div class="col-md-12">
            <div class="box box-info">
               ...
               <div class="box-body table-responsive">
                  <div>
                     <div class="download_label"><?php echo $this->lang->line('homework'); ?></div>
                           ...
                           ?>
                              <tr>
                                 ...
                                 <td class="mailbox-date pull-right">
                                    <a onclick="upload_docs('<?php echo $homework['id']; ?>', '<?php echo $upload_docsButton; ?>');" class="btn btn-default btn-xs" data-toggle="tooltip" data-original-title="<?php echo ("Submit " . $this->lang->line('homework')); ?>"><i class="fa fa-upload"></i></a>
