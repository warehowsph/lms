            ...
            ?>
               <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                  ...
                  <ul class="treeview-menu">
                     ...
                     ?>
                     <!-- kampu/paymongo_collections"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('kampuspay_collections'); ?></a>
                        </li> -->
                     <?php //}
               ...
               <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                  ...
                  <ul class="treeview-menu">
                     ...
                     ?>
                        ...
                        <li class="<?php echo set_Submenu('sessions/index'); ?>"><a href="<?php echo base_url(); ?>session_settings"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('session_setting'); ?></a></li>
                     <?php
                     }
