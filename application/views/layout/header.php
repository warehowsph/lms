...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="<?php //echo base_url(); 
                                                      ?>backend/dist/css/bootstrap-select.min.css"> -->
   ...
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/custom/jquery.min.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/dist/js/moment.min.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/datepicker/js/bootstrap-datetimepicker.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/plugins/colorpicker/bootstrap-colorpicker.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/datepicker/date.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/dist/js/jquery-ui.min.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/js/school-custom.js"></script>
   <script type="text/javascript" src="<?php echo base_url(); ?>backend/js/school-admin-custom.js"></script>
   ...
   <div class="wrapper">
      ...
      <header class="main-header" id="alert">
         <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">
            <span class="logo-mini"><img src="<?php echo ($_SESSION['S3_BaseUrl']); //base_url(); 
                                                ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo(); ?>" alt="<?php echo $this->customlib->getAppName() ?>" /></span>
            <span class="logo-lg"><img src="<?php echo ($_SESSION['S3_BaseUrl']); //base_url(); 
                                             ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo(); ?>" alt="<?php echo $this->customlib->getAppName() ?>" /></span>
         </a>
                              ...
                              <li>
                                 <div class="sstopuser">
                                    <div class="ssuserleft">
                                       <a href="<?php echo base_url() . "admin/staff/profile/" . $id ?>"><img src="<?php echo ($_SESSION['S3_BaseUrl'] . $file); ?>" alt="User Image"></a>
                                    </div>
