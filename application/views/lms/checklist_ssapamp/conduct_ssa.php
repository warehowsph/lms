                                                                    ...
                                                                    <table class="table table-striped table-bordered table-hover example nowrap" cellspacing="0" width="100%">
                                                                        <thead>
                                                                            <tr>								
                                                                                ...
                                                                                <th class="text-center">Checklist Grade</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <?php if (!empty($resultlist)) { 
                                                                                foreach($resultlist as $row) {
                                                                                    ...
                                                                                    echo "<a data-placement=\"right\" href=\"" . site_url('lms/grading_checklist_ssapamp/view_index/' . $row->id . '-' . $quarter_id ) . "\" class=\"btn btn-default btn-xs duplicate\" data-toggle=\"tooltip\" title=\"Edit\">";
