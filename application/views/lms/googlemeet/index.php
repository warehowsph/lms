        ...
        <div class="row">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Teacher's Google Meet IDs</h3>
                                ...
                                <tbody>
                                    <?php foreach ($list as $list_key => $list_data): ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <input style="width: 100%" type="text" class="google_meet" staff_id="<?php echo $list_data['id']?>" value="<?php echo $list_data['google_meet']?>" name="">
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.google_meet').change(function(){
            ...
            var google_meet = $(this).val();
            var url = '<?php echo base_url()."lms/googlemeet/google_meet_updated"; ?>';
            $.ajax({
                url: url,
                type: 'POST',
                data: { 
