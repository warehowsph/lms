...
<body>
   <header class="main-header">
      <div class="container">
         <div class="row">
            <div class=""><img src="<?php echo $_SESSION['S3_BaseUrl']; ?>/uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo(); ?>" class="margin-auto" width="162" height="29" /></div>
         </div>
      </div>
   </header>
   <div class="container text-center">
      <div class="row">
         <div class="space30">
            <img src="<?php echo base_url(); ?>/backend/images/errorimg.png" class="img-responsive margin-auto" />
         </div>
