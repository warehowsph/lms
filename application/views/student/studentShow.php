                                 ...
                                 <a class="" href="<?php echo base_url() . "student/view/" . $stvalue["id"] ?>">
                                    <div class="icon"><img src="<?php
                                                                  if (!empty($stvalue["image"])) {
                                                                     echo $_SESSION['S3_BaseUrl'] . $stvalue["image"];
                                                                  } else {
                     ...
                     <?php foreach ($siblings as $sibling_key => $sibling_value) { ?>
                        <div class="box box-widget widget-user-2">
                           ...
                           <div class="siblingview">
                              <img class="" src="<?php echo $_SESSION['S3_BaseUrl'] . $sibling_value->image; ?>" alt="User Avatar">
                        ...
                        <div class="table-responsive around10 pt0">
                           <table class="table table-hover table-striped tmb0">
                              <tbody>
                                 ...
                                 ?>
                                 <!-- <tr>
                                                <td><?php //echo $this->lang->line('cast'); 
                                                      ?></td>
                                                <td><?php //echo $student['cast']; 
                                                      ?></td>
                                            </tr> -->
                                 <?php //} 
                                 ...
                                 if ($sch_setting->student_email) {  ?>
                                    ...
                                    <!-- <tr>
                                                ...
                                                <td><button onclick="send_login_credentials(<?php //echo $student['id'] 
                                                                                             ?>)">Login Credentials</button></td>
                                            </tr> -->
                                 <?php } ?>
                                 <?php
                        ...
                        <div class="table-responsive around10 pt0">
                           <table class="table table-hover table-striped tmb0">
                              <tbody>
                                 ...
                                 ?>
                                 <!-- <tr>
                                                <td  class="col-md-4"><?php //echo $this->lang->line('measurement_date'); 
                                                                        ?></td>
