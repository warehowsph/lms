         ...
         <div class="col-lg-2 col-md-3 col-sm-12 uploadsticky">
            <div class="box box-primary">
               <div class="box-body text-center">
                  ...
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/logo/images.png" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                  <?php
                  } else {
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/logo/<?php echo $settinglist[0]['image']; ?>" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                  <?php
                  }
                  ?>
                  <br />
            ...
            <div class="box box-primary">
               <div class="box-body text-center">
                  ...
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/admin_logo/images.png" class="img-thumbnail " alt="Cinque Terre" width="204" height="60">
                  <?php
                  } else {
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/admin_logo/<?php echo $settinglist[0]['admin_logo']; ?>" class="img-thumbnail" alt="" width="204" height="60">
                  <?php
                  }
                  ?>
                  <br />
            ...
            <div class="box box-primary">
               <div class="box-body text-center">
                  ...
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/logo/images.png" class="img-thumbnail" alt="Cinque Terre" width="" height="">
                  <?php
                  } else {
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/admin_small_logo/<?php echo $settinglist[0]['admin_small_logo']; ?>" class="" alt="Cinque Terre" width="" height="">
                  <?php
                  }
                  ?>
                  <br />
            ...
            <div class="box box-primary">
               <div class="box-body text-center">
                  ...
                  if ($result->app_logo == "") {
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/logo/images.png" class="img-thumbnail img-responsive " alt="" width="" height="">
                  <?php
                  } else {
                  ?>
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/school_content/logo/app_logo/<?php echo $result->app_logo; ?>" class="img-responsive" alt="" width="" height="">
                  <?php
                  }
                  ?>
                  <br />
