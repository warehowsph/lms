                                    ...
                                    <div id="carousel-2" class="carousel slide slide-carousel" data-ride="carousel">
                                       <div class="carousel-inner">
                                          <div class="item active">
                                             <a href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>"> <img class="img-responsive img-thumbnail width150" alt="<?php echo strtoupper($student['lastname']) . ", " . strtoupper($student['firstname']) . " " . strtoupper($student['middlename']) ?>" src="<?php echo $_SESSION['S3_BaseUrl'] . $image ?>" alt="Image"></a>
                                          </div>
                                       </div>
                                    </div>
