                        ...
                        <div class="row">
                           <div class="box-body">
                              <div class="col-md-6 col-sm-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                       ...
                                       <input type="file" class="filestyle form-control-file" name="logo" id="exampleInputFile" data-height="100" data-default-file="<?php echo $_SESSION['S3_BaseUrl'] . $frontcmslist->logo; ?>">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                       ...
                                       <input type="file" class="filestyle form-control-file" name="fav_icon" id="exampleInputFile" data-height="50" data-default-file="<?php echo $_SESSION['S3_BaseUrl'] . $frontcmslist->fav_icon; ?>">
                                    </div>
                                 </div>
                              ...
                              <div class="col-md-5 col-md-offset-1 col-sm-12">
                                 ...
                                 <!-- <label for="input-type"><?php //echo $this->lang->line('social_media');   
                                                               ?></label>
<hr/> -->
                                 <div class="form-group">
