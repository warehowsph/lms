                           ...
                           ?>
                                 <div class='col-sm-3 col-md-2 col-xs-6 img_div_modal gallery_img div_record_<?php echo $banner_image_value->id ?>'>
                                    <div class='fadeoverlay'>
                                       <img class='img-responsive' data-fid='<?php echo $banner_image_value->id ?>' data-content_name='<?php echo $banner_image_value->img_name; ?>' data-img='<?php echo $_SESSION['S3_BaseUrl'] . $banner_image_value->thumb_path . $banner_image_value->img_name ?>' src='<?php echo $_SESSION['S3_BaseUrl'] . $banner_image_value->thumb_path . $banner_image_value->img_name ?>'>
                                       <?php
