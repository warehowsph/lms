            ...
            <table width="100%">
               <tr>
                  ...
                  <td style="height: 100px;width: 850px;">
                     <div><img src="<?php echo $_SESSION['S3_BaseUrl'] ?>/uploads/print_headerfooter/staff_payslip/<?php $this->setting_model->get_payslipheader(); ?>" style="height: 100px;width: 100%;" /></div>
