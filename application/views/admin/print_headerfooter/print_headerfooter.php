                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <input id="documents" data-default-file="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/print_headerfooter/student_receipt/<?php echo $result[1]['header_image'] ?>" placeholder="" type="file" class="filestyle form-control" data-height="180" name="header_image">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <input id="documents" data-default-file="<?php echo $_SESSION['S3_BaseUrl'] ?>uploads/print_headerfooter/staff_payslip/<?php echo $result[0]['header_image'] ?>" placeholder="" type="file" class="filestyle form-control" data-height="180" name="header_image">
