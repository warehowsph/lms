                        ...
                        ?>
                           <table class="table table-hover table stripped">
                              ...
                              <tbody>
                                 ...
                                 ?>
                                    <tr>
                                       <!-- <td><?php //echo $students_value->firstname." ".$students_value->lastname." (".$students_value->admission_no.")"; 
                                                ?></td> -->
                                       <td><?php echo $students_value->lastname . ", " . $students_value->firstname; ?></td>
                                       <?php
