...
?>
      ...
      <div class="mark-container">
         <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/admit_card/' . $admitcard->background_img; ?>" class="tcmybg" width="100%" height="100%" />
         <table cellpadding="0" cellspacing="0" width="100%" class="tablemain">
            <tr>
               <td valign="top">
                  <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                        <td valign="top" align="center"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/admit_card/' . $admitcard->left_logo; ?>" width="100" height="100"></td>
                        <td valign="top">
                           <table cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                        ...
                        <td valign="top" align="center"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/admit_card/' . $admitcard->right_logo; ?>" width="100" height="100"></td>
                     </tr>
                  </table>
               </td>
            </tr>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" style="text-transform: uppercase;">
                     <tr>
                        ...
                        <td valign="top" width="25%" align="right">
                           ...
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . $student_value->image; ?>" width="100" height="130" style="border: 2px solid #fff;
               ...
               <td align="right" valign="top">
                  <table cellpadding="0" cellspacing="0" width="100%" style="text-align: center;">
                     <tr>
                        ...
                        <td valign="top">
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/admit_card/' . $admitcard->sign; ?>" width="100" height="38" />
                           <p>Principal</p>
                        </td>
