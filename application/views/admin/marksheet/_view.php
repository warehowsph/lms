...
<body class="body">
   ...
   ?>
      <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/marksheet/' . $marksheet->background_img; ?>" class="tcmybg" width="100%" height="100%" />
   <?php
   }
   ?>
               ...
               <table cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                     <td width="100" valign="top" align="center" style="padding-left: 0px;">
                        ...
                        ?>
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/marksheet/' . $marksheet->left_logo; ?>" width="100" height="100">
                     ...
                     <td width="100" valign="top" align="right" style="padding-right: 0px;">
                        ...
                        ?>
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/marksheet/' . $marksheet->right_logo; ?>" width="100" height="100">
                        <?php
                        }
                        ?>
                  ...
                  <tr>
                     ...
                     ?>
                        <td width="100" valign="top" align="center" style="padding-left: 5px;">
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_images/no_image.png'; ?>" width="100" height="100" />
                        </td>
                     <?php
                     }
                     ?>
                  ...
                  <tr>
                     ...
                     ?>
                        <td valign="bottom" align="center" style="text-transform: uppercase;">
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/marksheet/' . $marksheet->left_sign; ?>" width="100" height="50">
                        </td>
                     <?php
                     }
                     ?>
                     ...
                     ?>
                        <td valign="bottom" align="center" style="text-transform: uppercase;">
                           ...
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/marksheet/' . $marksheet->middle_sign; ?>" width="100" height="50">
                        </td>
                     <?php
                     }
                     ?>
                     ...
                     ?>
                        <td valign="bottom" align="center" style="text-transform: uppercase;">
                           ...
                           <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/marksheet/' . $marksheet->right_sign; ?>" width="100" height="50">
                        </td>
                     <?php
                     }
                     ?>
