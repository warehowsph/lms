...
<div class="content-wrapper" style="min-height: 946px;">  
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('transmuted_grades', 'can_add')) { ?>        
                <div class="col-md-4">          
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_transmuted_grade'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('admin/classrecord/transmutedgrades') ?>"  id="transmutedgradesform" name="transmutedgradesform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="grade" name="grade"  placeholder="" type="number" step="any" min="0" max="100" class="form-control"  value="<?php echo set_value('grade'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="transmute_from" name="transmute_from" placeholder="" type="number" step="any" min="0" max="100" class="form-control"  value="<?php echo set_value('transmute_from'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="transmute_to" name="transmute_to" placeholder="" type="number" step="any" min="0" max="100" class="form-control"  value="<?php echo set_value('transmute_to'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="remarks" name="remarks" placeholder="" type="text" class="form-control"  value="<?php echo set_value('remarks'); ?>" />
