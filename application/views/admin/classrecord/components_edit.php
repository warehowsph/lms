...
<div class="content-wrapper" style="min-height: 946px;">  
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('components', 'can_add') || $this->rbac->hasPrivilege('components', 'can_edit')) { ?>
                <div class="col-md-4">          
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_component'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('admin/classrecord/component_edit/'.$id) ?>"  id="componentform" name="componentform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="name" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name', $component['name']); ?>" />
