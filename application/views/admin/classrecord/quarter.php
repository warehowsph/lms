...
<div class="content-wrapper" style="min-height: 946px;">  
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('quarter', 'can_add')) { ?>        
                <div class="col-md-4">          
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_quarter'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('admin/classrecord/quarter') ?>"  id="quarterform" name="quarterform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                    ...
                                    foreach ($quarterlist as $quarter) { ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                                <?php if ($this->rbac->hasPrivilege('quarter', 'can_edit')) { ?>
