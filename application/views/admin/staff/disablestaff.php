                              ...
                              <div class="col-sm-12">
                                 <div class="form-group">
                                    ...
                                    <select name="role" class="form-control">
                                       ...
                                       ?>
                                          <option <?php if ($search_role == $role_value['type']) {
                                                      echo "selected";
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 img_div_modal">
                                       <div class="staffinfo-box">
                                          <div class="staffleft-box">
                                             ...
                                             ?>
                                             <img src="<?php echo $_SESSION['S3_BaseUrl'] . "uploads/staff_images/" . $image ?>" />
                                          </div>
                                          <div class="staffleft-content">
                                             ...
                                             <p>
                                                <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $staff["employee_id"] ?></font>
                                             </p>

                                             <p>
                                                <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $staff["contact_no"] ?></font>
                                             </p>

                                             <p>
                                                <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php
                                                                                                                                    if (!empty($staff["location"])) {
                                                                                                                                       echo $staff["location"] . ",";
                                                                                                                                    }
                                                                                                                                    ?></font>
                                                <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $staff["department"]; ?></font>
                                             </p>
