                     ...
                     <div class="tab-pane <?php
                        ...
                        ?>
                              <div class="studentname">
                                 <a href="<?php echo $_SESSION['S3_BaseUrl'] . "admin/staff/profile/" . $svalue["id"] ?>">
                                    <div class="icon"><img src="<?php echo $_SESSION['S3_BaseUrl'] . "uploads/staff_images/" . $image; ?>" alt="User Image"></div>
         ...
         <div class="col-md-3">
            <div class="box box-primary" <?php
               ...
               <div class="box-body box-profile">
                  ...
                  ?>
                  <img class="profile-user-img img-responsive img-circle" src="<?php echo $_SESSION['S3_BaseUrl'] . "uploads/staff_images/" . $file ?>" alt="User profile picture">
                  ...
                  <?php if ($staff['user_type'] == 'Teacher') { ?>
                     ...
                     <?php if ($rate_canview == 1) { ?><center>
                        ...
                        <center>
                           <h5><?php echo substr($rate, 0, 3); ?> average based on <?php echo $reviews; ?> reviews.</h5>
                        </center> <?php }
                              } ?>
