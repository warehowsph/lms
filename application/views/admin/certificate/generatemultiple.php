      ...
      ?>
         <td valign="top" class="width32">
            <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #efefef;">
               <tr>
                  <td valign="top">
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/background/' . $id_card[0]->background; ?>" class="tcmybg" />
                  </td>
               </tr>
               <tr>
                  <td valign="top">
                     <div class="studenttop" style="background: <?php echo $id_card[0]->header_color ?>">
                        ...
                        <div class="sttext1"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/logo/' . $id_card[0]->logo; ?>" width="30" height="30" />
                  ...
                  <td valign="top">
                     <div class="staround">
                        <div class="cardleft">
                           ...
                           <div class="stimg">
                              <img src="<?php echo $_SESSION['S3_BaseUrl'] . $student->image; ?>" class="img-responsive" />
                           </div>
                        </div>
                        <!--./cardleft-->
                        <div class="cardright">
               ...
               <tr>
                  <td valign="top" align="right" class="principal"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/signature/' . $id_card[0]->sign_image; ?>" width="66" height="40" /></td>
               </tr>
            </table>
         </td>
