...
?>
   ...
   <div class="" style="position: relative; text-align: center; font-family: 'arial';">
      <?php if (!empty($certificate[0]->background_image)) { ?>
         <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/certificate/' . $certificate[0]->background_image; ?>" style="width: 100%; height: 100vh" />
      <?php } ?>
         ...
         <tr>
            <td style="position: absolute;right:0;">
               <?php if ($certificate[0]->enable_student_image == 1) { ?>
                  <img style="position: relative; <?php echo "top:" . $certificate[0]->enable_image_height . "px" ?>;" src="<?php echo $_SESSION['S3_BaseUrl'] . $student->image; ?>" width="100" height="auto">
               <?php } ?>
            </td>
         </tr>
         <tr>
