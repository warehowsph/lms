         ...
         <tr>
            <td valign="top" width="32%">
               <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #efefef;">
                  <tr>
                     <td valign="top">
                        <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/background/' ?><?php echo $idcardlist[0]->background; ?>" class="tcmybg" />
                     </td>
                  </tr>
                  <tr>
                     <td valign="top">
                        <div class="studenttop">
                           <div class="sttext1"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/logo/' ?><?php echo $idcardlist[0]->logo; ?>" width="30" height="30" />
                  ...
                  <tr>
                     <td valign="top">
                        <div class="staround">
                           <div class="cardleft">
                              <div class="stimg">
                                 <img src="<?php echo $_SESSION['S3_BaseUrl'] ?><?php echo $resultlist[0]['image']; ?>" class="img-responsive" />
                              </div>
                           </div>
                           <!--./cardleft-->
                           <div class="cardright">
                  ...
                  <tr>
                     <td valign="top" align="right" class="principal"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/signature.png' ?>" width="66" height="40" /></td>
                  </tr>
               </table>
            </td>
         </tr>
