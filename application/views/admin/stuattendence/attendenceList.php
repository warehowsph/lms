                                                    ...
                                                    foreach ($resultlist as $key => $value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="radio radio-info radio-inline">
                                                                    <input checked <?php if ($attendancefrom == 'Campus Meetup') echo "checked"; ?> type="radio" id="attendancefrom<?php echo $value['student_session_id']."-1"; ?>" value="Campus Meetup" name="attendancefrom<?php echo $value['student_session_id']; ?>" >                                                                    
