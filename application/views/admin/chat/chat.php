            ...
            <div id="frame">
               ...
               <div class="chatcontent">
                  <div class="contact-profile">
                     <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_images/no_image.png'; ?>" alt="" />
...
<script>
   ...
   // var base_url = "<?php //echo $_SESSION['S3_BaseUrl'] 
                        ?>";
         ...
         success: function(data) {
            if (data.status == 0) {
               ...
               if (data.new_user.user_type == "student") {
                  ...
                  img = "<?php echo $_SESSION['S3_BaseUrl'] ?>" + data.new_user.image;
               } else if (data.new_user.user_type == "staff") {
                  new_user_type = "Staff";
                  img = "<?php echo $_SESSION['S3_BaseUrl'] ?>" + "uploads/staff_images/" + data.new_user.image;
               }
   ...
   function newUserLi(user_array, chat_connection_id) {
      ...
      if (user_array.user_type == "student") {
         new_user_type = "Student";
         img = "<?php echo $_SESSION['S3_BaseUrl'] ?>" + user_array.image;
      } else if (user_array.user_type == "staff") {
         new_user_type = "Staff";
         img = "<?php echo $_SESSION['S3_BaseUrl'] ?>" + "uploads/staff_images/" + user_array.image;
