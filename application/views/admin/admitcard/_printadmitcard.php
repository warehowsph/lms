                     ...
                     <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                           <td valign="top" align="center" width="100">
                              ...
                              ?>
                                 <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/admit_card/' . $admitcard->left_logo; ?>" width="100" height="100">
                              <?php
                              }
                              ?>
                           </td>
                           ...
                           <td width="100" valign="top" align="center">
                              ...
                              ?>
                                 <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/admit_card/' . $admitcard->right_logo; ?>" width="100" height="100">
