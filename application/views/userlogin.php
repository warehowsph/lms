...
<head>
   ...
   <style type="text/css">
      body {
         background-image: url("<?php echo $_SESSION['S3_BaseUrl']; ?>uploads/gallery/media/CampusCloudLMS.jpg");
      ...
      .loginbg {
         background-image: url("<?php echo $_SESSION['S3_BaseUrl']; ?>uploads/gallery/media/background%20for%20stud%20parent%20login.png");
         width: 100%;
         height: 100%;
         background-size: cover;
         background-repeat: no-repeat;
               ...
               <div class="<?php echo $bgoffsetbg; ?>">
                     ...
                     <div class="loginbg loginradius login390">
                        <div class="form-top">
                           <div class="form-top-left logowidth">
                              <img src="<?php echo $_SESSION['S3_BaseUrl']; ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo(); ?>" />
                           </div>
                        </div>
                  ...
                  <!-- <div class="col-md-6 col-sm-12 discover">
                            <img src="<?php //echo base_url(); 
                                       ?>backend/usertemplate/assets/img/backgrounds/discover.png">
                        </div> -->
               </div>
            </div>
         </div>
