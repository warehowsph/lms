         ...
         <div class="col-md-12">
            <div class="box removeboxmius">
               ...
               <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('select_criteria') . "-LPMS"; ?></h3>
               </div>
               ...
               <div class="">
                  ...
                  <div class="box-header ptbnull">
                     <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo form_error('class_record_quarterly'); ?> Student Grades</h3>
                  </div>
                                 ...
                                 <div class="box box-warning">
                                    <div class="box-header ptbnull">
                                       ...
                                       <div class="box-tools pull-right">
                                          <a href="<?php echo base_url('report/student_report_card_lpms') . '?session_id=' . $the_session_id . '&class_id=' . $the_class_id . '&section_id=' . $the_section_id . '&student_id=' . $the_student_id ?>" target="_blank">
                                    ...
                                    <div class="box-body">
                                       <div class="table-responsive">
                                          ...
                                          <table id="class_record" class="table table-striped table-bordered table-hover example nowrap">
                                             <thead>
                                                <tr>
                                                   <th rowspan="2" class="text-left">Subjects</th>
                                                   <?php
                                                   foreach ($quarter_list as $row) {
                                                      echo "<th colspan=\"4\" class=\"text-center\">" . $row->description . "</th>\r\n";
                                                   }
                                                   ?>
                                                ...
                                                <tr>
                                                   <?php
                                                   foreach ($quarter_list as $row) {
                                                      echo "<th class=\"text-center\">Transmuted</th>\r\n";
                                             ...
                                             <tbody>
                                                ...
                                                foreach ($resultlist as $row) {
                                                   ...
                                                   echo "<td class='text-center" . ($row->Q1 < 75 ? " text-danger" : ($row->Q1 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q1 == 0 ? '' : $row->Q1_CODE) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q1_CONDUCT < 75 ? " text-danger" : ($row->Q1_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q1_CONDUCT == 0 ? '' : $row->Q1_CONDUCT) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q1_CONDUCT < 75 ? " text-danger" : ($row->Q1_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q1_CONDUCT == 0 ? '' : $row->Q1_CONDUCTCODE) . "</b></td>\r\n";

                                                   echo "<td class='text-center" . ($row->Q2 < 75 ? " text-danger" : ($row->Q2 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q2 == 0 ? '' : $row->Q2) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q2 < 75 ? " text-danger" : ($row->Q2 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q2 == 0 ? '' : $row->Q2_CODE) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q2_CONDUCT < 75 ? " text-danger" : ($row->Q2_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q2_CONDUCT == 0 ? '' : $row->Q2_CONDUCT) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q2_CONDUCT < 75 ? " text-danger" : ($row->Q2_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q2_CONDUCT == 0 ? '' : $row->Q2_CONDUCTCODE) . "</b></td>\r\n";

                                                   echo "<td class='text-center" . ($row->Q3 < 75 ? " text-danger" : ($row->Q3 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q3 == 0 ? '' : $row->Q3) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q3 < 75 ? " text-danger" : ($row->Q3 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q3 == 0 ? '' : $row->Q3_CODE) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q3_CONDUCT < 75 ? " text-danger" : ($row->Q3_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q3_CONDUCT == 0 ? '' : $row->Q3_CONDUCT) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q3_CONDUCT < 75 ? " text-danger" : ($row->Q3_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q3_CONDUCT == 0 ? '' : $row->Q3_CONDUCTCODE) . "</b></td>\r\n";

                                                   echo "<td class='text-center" . ($row->Q4 < 75 ? " text-danger" : ($row->Q4 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q4 == 0 ? '' : $row->Q4) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q4 < 75 ? " text-danger" : ($row->Q4 >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q4 == 0 ? '' : $row->Q4_CODE) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q4_CONDUCT < 75 ? " text-danger" : ($row->Q4_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q4_CONDUCT == 0 ? '' : $row->Q4_CONDUCT) . "</b></td>\r\n";
                                                   echo "<td class='text-center" . ($row->Q4_CONDUCT < 75 ? " text-danger" : ($row->Q4_CONDUCT >= 90 ? " text-success" : "")) . "'><b>" . ($row->Q4_CONDUCT == 0 ? '' : $row->Q4_CONDUCTCODE) . "</b></td>\r\n";
