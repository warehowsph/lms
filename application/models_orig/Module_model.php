...
class Module_model extends MY_Model
{
   ...
   function getPermission()
   {
      ...
      $query = $this->db->where("system", 0)->get("permission_group")->order_by("permission_group.name");
   ...
   function getParentPermission()
   {
      ...
      $query = $this->db->where("system", 0)->get("permission_parent")->order_by("permission_parent.name");
      return $query->result_array();
   }
   ...
   function getStudentPermission()
   {
      ...
      $query = $this->db->where("system", 0)->get("permission_student")->order_by("permission_student.name");
      return $query->result_array();
   }
   ...
   public function get($id = null)
   {
      ...
      if ($id != null) {
         ...
         $this->db->order_by('permission_group.name');
      }
      $query = $this->db->get();
      if ($id != null) {
         return $query->row_array();
   ...
   public function get_parent($id = null)
   {
      ...
      if ($id != null) {
         ...
         $this->db->order_by('permission_parent.name');
      }
      $query = $this->db->get();
      if ($id != null) {
         return $query->row_array();
   ...
   public function get_student($id = null)
   {
      ...
      if ($id != null) {
         ...
         $this->db->order_by('permission_student.name');
      }
      $query = $this->db->get();
      if ($id != null) {
         return $query->row_array();
