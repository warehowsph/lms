      ...
      if ($this->form_validation->run() == FALSE) {
         ...
         if (!empty($_FILES['background_image']['name'])) {
            ...
            if ($this->upload->do_upload('background_image')) {
               ...
               $dest_file = $_SESSION['School_Code'] . "/uploads/student_id_card/background/" . $background;
               $s3->putObjectFile('uploads/student_id_card/background/' . $background, S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
               unlink('uploads/student_id_card/background/' . $background);
            } else {
               $background = '';
            }
         } else {
         ...
         if (!empty($_FILES['logo_img']['name'])) {
            ...
            if ($this->upload->do_upload('logo_img')) {
               ...
               //-- Upload to AWS S3 then remove the original file              
               $dest_file = $_SESSION['School_Code'] . "/uploads/student_id_card/logo/" . $logo_img;
               $s3->putObjectFile('uploads/student_id_card/logo/' . $logo_img, S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
               unlink('uploads/student_id_card/logo/' . $logo_img);
            } else {
               $logo_img = '';
            }
         } else {
         ...
         if (!empty($_FILES['sign_image']['name'])) {
            ...
            if ($this->upload->do_upload('sign_image')) {
               ...
               //-- Upload to AWS S3 then remove the original file              
               $dest_file = $_SESSION['School_Code'] . "/uploads/student_id_card/signature/" . $sign_image;
               $s3->putObjectFile('uploads/student_id_card/signature/' . $sign_image, S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
               unlink('uploads/student_id_card/signature/' . $sign_image);
            } else {
               $sign_image = '';
            }
         } else {
         ...
         <tr>
            <td valign="top" width="32%" style="padding: 3px;">
               <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #efefef;">
                  <tr>
                     <td valign="top">
                        <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/background/' ?><?php echo $idcard->background; ?>" class="tcmybg" style="opacity: .1" />
                     </td>
                  </tr>
                  <tr>
                     <td valign="top">
                        <div class="studenttop">
                           <div class="sttext1"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/logo/' ?><?php echo $idcard->logo; ?>" width="30" height="30" />
                  ...
                  <tr>
                     <td valign="top">
                        <div class="staround">
                           <div class="cardleft">
                              <div class="stimg">
                                 <img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_images/no_image.png' ?>" class="img-responsive" />
                              </div>
                           </div>
                           <!--./cardleft-->
                           <div class="cardright">
                  ...
                  <tr>
                     <td valign="top" align="right" class="principal"><img src="<?php echo $_SESSION['S3_BaseUrl'] . 'uploads/student_id_card/signature/' ?><?php echo $idcard->sign_image; ?>" width="66" height="40" /></td>
                  </tr>
               </table>
            </td>
         </tr>
