      ...
      if ($this->form_validation->run() == true) {
         ...
         if ($insert) {
            ...
            if (isset($_FILES["file"]) && !empty($_FILES['file']['name'])) {
               ...
               $dest_file = $_SESSION['School_Code'] . "/uploads/staff_images/" . $img_name;
            ...
            if (isset($_FILES["first_doc"]) && !empty($_FILES['first_doc']['name'])) {
               ...
               $dest_file = $_SESSION['School_Code'] . "/uploads/staff_documents/" . $staff_id . '/' . $filename;
            ...
            if (isset($_FILES["second_doc"]) && !empty($_FILES['second_doc']['name'])) {
               ...
               $dest_file = $_SESSION['School_Code'] . "/uploads/staff_documents/" . $insert_id . '/' . $filename;
            ...
            if (isset($_FILES["third_doc"]) && !empty($_FILES['third_doc']['name'])) {
               ...
               $dest_file = $_SESSION['School_Code'] . "/uploads/staff_documents/" . $insert_id . '/' . $filename;
               $s3->putObjectFile($_FILES["third_doc"]["tmp_name"], S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
            } else {
            ...
            if (isset($_FILES["fourth_doc"]) && !empty($_FILES['fourth_doc']['name'])) {
               ...
               $dest_file = $_SESSION['School_Code'] . "/uploads/staff_documents/" . $insert_id . '/' . $fourth_doc;
   ...
   public function edit($id)
   {
      ...
      if ($this->form_validation->run() == false) {
         ...
         if (isset($_FILES["first_doc"]) && !empty($_FILES['first_doc']['name'])) {
            ...
            // move_uploaded_file($_FILES["first_doc"]["tmp_name"], $img_name);
            $dest_file = $_SESSION['School_Code'] . "/uploads/staff_images/" . $id . '/' . $resume_doc;
            $s3->putObjectFile($_FILES["first_doc"]["tmp_name"], S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
         } else {
         ...
         if (isset($_FILES["second_doc"]) && !empty($_FILES['second_doc']['name'])) {
            ...
            // move_uploaded_file($_FILES["second_doc"]["tmp_name"], $img_name);
            $dest_file = $_SESSION['School_Code'] . "/uploads/staff_images/" . $id . '/' . $joining_letter_doc;
            $s3->putObjectFile($_FILES["second_doc"]["tmp_name"], S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
         } else {
         ...
         if (isset($_FILES["third_doc"]) && !empty($_FILES['third_doc']['name'])) {
            ...
            // move_uploaded_file($_FILES["third_doc"]["tmp_name"], $img_name);
            $dest_file = $_SESSION['School_Code'] . "/uploads/staff_images/" . $id . '/' . $resignation_letter_doc;
            $s3->putObjectFile($_FILES["third_doc"]["tmp_name"], S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
         } else {
         ...
         if (isset($_FILES["fourth_doc"]) && !empty($_FILES['fourth_doc']['name'])) {
            ...
            // move_uploaded_file($_FILES["fourth_doc"]["tmp_name"], $img_name);
            $dest_file = $_SESSION['School_Code'] . "/uploads/staff_images/" . $id . '/' . $fourth_doc;
            $s3->putObjectFile($_FILES["fourth_doc"]["tmp_name"], S3_BUCKET, $dest_file, S3::ACL_PUBLIC_READ);
         } else {
