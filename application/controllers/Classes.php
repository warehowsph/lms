...
class Classes extends Admin_Controller
{
   ...
   public function get_grade_level_terms()
   {
      $grade_level_id = $this->input->get('class_id');
      $grade_level_info = $this->class_model->get_grade_level_info($grade_level_id);
      $data = $this->general_model->get_quarter_list($grade_level_info['term_alias'], $grade_level_info['term_length']);
